    ...
    <table>
      <thead>
        <tr>
          ...
          <th>Tipe</th>
          <th>Bin to Bin</th>
          <th class="r" style="width:50px">Qty Moved</th>
          <th>Batch</th>
          <th>Expiry</th>
      ...
      <tr>
        ...
        <td>
          ...
          <?php if ($b2b): ?>
          <span class="chip" style="background:#fef3c7;color:#92400e;font-size:13px;font-weight:600;padding:2px 6px"><?= htmlspecialchars($b2b) ?></span>
          <?php else: ?>
          <span style="color:#cbd5e1;font-size:13px">—</span>
          <?php endif; ?>
        </td>
        <td class="r" style="font-weight:700">
          <?php $qm = $pick['qty_moved'] ?? null; ?>
          <?= $qm !== null ? number_format($qm, 0) : '—' ?>
        </td>
        <td>
        ...
        <td style="font-size:13px;color:#64748b"><?= $pick['expiry_date'] ?? '—' ?></td>
  ...
  <div style="margin-top:20px;page-break-before:always">
    ...
    <table style="page-break-inside:avoid">
      ...
      <tr>
        ...
        <td style="font-size:13px;color:#64748b"><?= htmlspecialchars($rep['uom_type'] ?? 'EA') ?></td>
        <td class="c"><span class="check-box"></span></td>
      </tr>
      <?php endforeach; ?>
      </tbody>
